...
// RelayConfig controls behavior when a new Relay is created for an allocation
type RelayConfig struct {
	// When creating a new Relay this is the passed to ListenPacket
	// 0.0.0.0 is what most people use,  unless you wish to filter what interface you listen on
	ListeningAddress string

	// If non-empty this is the address returned after creating the allocation
	// If you are behind a NAT (like AWS) this should be your Public IP Address
	// If none is given LocalAddr will be used on the created PacketConn from ListeningAddress
	ExternalAddress string

	// Min/Max Ports for server to create allocations on
